...
List<Destination> destinations = [
  Destination(
    ...
    city: 'Tokyo',
    country: 'Japan',
    description: 'Visit Japan for the next holiday',
  ...
  Destination(
    ...
    city: 'Machupichu',
    country: 'Peru',
    description: 'Visit Peru for the next holiday',
    activities: activities
  ),
  Destination(
    ...
    description: 'Visit Islas Maldivas for the next holiday',
    activities: activities
  ),
  Destination(
    ...
    city: 'Chin Buri',
    country: 'Thailand',
    description: 'Visit Thailand for the next holiday',
    activities: activities
  ),
];
